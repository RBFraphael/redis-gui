const es = {
  message: {
    ...
    mac_not_support_auto_update: 'Mac no soporte actualizaciones automáticas. Manualmente puede <a href="https://github.com/rbfraphael/redis-gui/releases">Descargarla</a> y reinstalarla,\
