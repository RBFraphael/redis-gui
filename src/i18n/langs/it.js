const it = {
  message: {
    ...
    mac_not_support_auto_update: 'Il Mac non supporta l\'aggiornamento automatico, Si prega di <a href="https://github.com/rbfraphael/redis-gui/releases">scaricare</a> e reinstallare manualmente,\
