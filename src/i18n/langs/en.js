const en = {
  message: {
    ...
    mac_not_support_auto_update: 'Mac Does Not Support Automatic Update, Please Manually <a href="https://github.com/rbfraphael/redis-gui/releases">Download</a> And Reinstall,\
