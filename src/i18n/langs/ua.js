const ua = {
  message: {
    ...
    mac_not_support_auto_update: 'MacOS не підтримує автоматичне оновлення, <a href="https://github.com/rbfraphael/redis-gui/releases">скачайте</a> і перевстановіть додаток вручну, \
