const de = {
  message: {
    ...
    mac_not_support_auto_update: 'Mac unterstützt keine automatische Aktualisierung, bitte manuell <a href="https://github.com/rbfraphael/redis-gui/releases">herunterladen</a> und neu installieren,\
